...
<head>
  ...
  <title>Approval Cuti — Sistem Cuti Karyawan</title>
  ...
  <div class="main-content">
    <div class="topbar">
      <div class="topbar-title">
        <h1><i class="fa-solid fa-circle-check" style="color:var(--success);margin-right:10px"></i>Approval Cuti</h1>
        <p>Menu khusus admin untuk menyetujui atau menolak pengajuan cuti</p>
      </div>
    ...
    <div class="page-body page-wide">
      <div id="approval-alert" class="statusMsg"></div>
      <div class="card">
        <div class="card-header"><h3>Daftar Pengajuan Pending</h3><span class="card-subtitle">Klik Approve/Tolak pada data yang masih pending</span></div>
        <div class="card-body" style="padding:0"><div class="table-responsive"><div id="view"><div id="data-approval"></div></div></div></div>
      </div>
    </div>
  </div>
</div>
