...
$data = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM jadwalcuti WHERE nik=".$nik));
...
<form class="form-horizontal" id="form-jadwalcuti">
     <p class="statusMsg"></p>
	 ...
	 <div class="control-group">
		...
		<div class="controls">
			<!-- <input type="text" id="levelkaryawan" class="input-xlarge" name="levelkaryawan" value="<?php //echo $levelkaryawan ?>"> -->
				...
				<?php 
				// tampilkan untuk form ubah jadwalcuti
				if($nik > 0) { ?>
	...
	// $cek_user=mysqli_num_rows(mysqli_query($connect, "SELECT * FROM jadwalcuti WHERE nik='123123'"));
//if ($cek_user > 0) {
