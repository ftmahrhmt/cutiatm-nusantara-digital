...
$data = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM karyawan WHERE nik=".$nik));
	 ...
	 <div class="control-group">
		...
		<div class="controls">
			<!-- <input type="text" id="levelkaryawan" class="input-xlarge" name="levelkaryawan" value="<?php //echo $levelkaryawan ?>"> -->
				...
				<?php 
				// tampilkan untuk form ubah karyawan
				if($nik > 0) { ?>
					<option value="<?php echo $levelkaryawan ?>"><?php echo $levelkaryawan ?></option>
				        <?php
                                          ...
                                          echo'<option value="Direktur">Direktur</option>';
                                          ...
                                          echo '<option value="Manager">Manager</option>';
                                          echo'<option value="Direktur">Direktur</option>';
                                          }else if ($levelkaryawan == 'Direktur'){
